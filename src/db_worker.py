...
#                 if d_model:
#                     with open(f'tracker_receiver/src/protocols/{protocol_name}/configurations/{d_model}.json',
#                               'r') as fd:
#                         settings = load(fd)
#                         model = d_model
#                 else:
...
def get_configuration():
    with open(f'src/protocols/WialonCombine/configurations/v2.json', 'r') as fd:
        settings = load(fd)
